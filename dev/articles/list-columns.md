...
```
    ...
    #>  1 /tmp/RtmpPbwjgA/file20342…    NA sche… <NA>   <NA>           NA <NA>            <NA>           <NULL>                     4    NA        NA       NA <int>
    #>  2 /tmp/RtmpPbwjgA/file20342…     1 id    integ… INT32          NA REQUIRED        INT_32         <INT(32, TRUE)>           NA    NA        NA       NA <int>
    #>  3 /tmp/RtmpPbwjgA/file20342…     2 ints  list(… <NA>           NA OPTIONAL        LIST           <LIST>                     1    NA        NA       NA <int>
    #>  4 /tmp/RtmpPbwjgA/file20342…     2 list  <NA>   <NA>           NA REPEATED        <NA>           <NULL>                     1    NA        NA       NA <int>
    #>  5 /tmp/RtmpPbwjgA/file20342…     2 elem… <NA>   INT32          NA OPTIONAL        INT_32         <INT(32, TRUE)>           NA    NA        NA       NA <int>
    #>  6 /tmp/RtmpPbwjgA/file20342…     3 doub… list(… <NA>           NA OPTIONAL        LIST           <LIST>                     1    NA        NA       NA <int>
    #>  7 /tmp/RtmpPbwjgA/file20342…     3 list  <NA>   <NA>           NA REPEATED        <NA>           <NULL>                     1    NA        NA       NA <int>
    #>  8 /tmp/RtmpPbwjgA/file20342…     3 elem… <NA>   DOUB…          NA OPTIONAL        <NA>           <NULL>                    NA    NA        NA       NA <int>
    #>  9 /tmp/RtmpPbwjgA/file20342…     4 stri… list(… <NA>           NA OPTIONAL        LIST           <LIST>                     1    NA        NA       NA <int>
    #> 10 /tmp/RtmpPbwjgA/file20342…     4 list  <NA>   <NA>           NA REPEATED        <NA>           <NULL>                     1    NA        NA       NA <int>
    #> 11 /tmp/RtmpPbwjgA/file20342…     4 elem… <NA>   BYTE…          NA OPTIONAL        UTF8           <STRING>                  NA    NA        NA       NA <int>
