...
```
    ...
    #>  1 /tmp/RtmpuXyklO/file1f0c3…    NA sche… <NA>   <NA>           NA <NA>            <NA>           <NULL>                     4    NA        NA       NA <int>
    #>  2 /tmp/RtmpuXyklO/file1f0c3…     1 id    integ… INT32          NA REQUIRED        INT_32         <INT(32, TRUE)>           NA    NA        NA       NA <int>
    #>  3 /tmp/RtmpuXyklO/file1f0c3…     2 ints  list(… <NA>           NA OPTIONAL        LIST           <LIST>                     1    NA        NA       NA <int>
    #>  4 /tmp/RtmpuXyklO/file1f0c3…     2 list  <NA>   <NA>           NA REPEATED        <NA>           <NULL>                     1    NA        NA       NA <int>
    #>  5 /tmp/RtmpuXyklO/file1f0c3…     2 elem… <NA>   INT32          NA OPTIONAL        INT_32         <INT(32, TRUE)>           NA    NA        NA       NA <int>
    #>  6 /tmp/RtmpuXyklO/file1f0c3…     3 doub… list(… <NA>           NA OPTIONAL        LIST           <LIST>                     1    NA        NA       NA <int>
    #>  7 /tmp/RtmpuXyklO/file1f0c3…     3 list  <NA>   <NA>           NA REPEATED        <NA>           <NULL>                     1    NA        NA       NA <int>
    #>  8 /tmp/RtmpuXyklO/file1f0c3…     3 elem… <NA>   DOUB…          NA OPTIONAL        <NA>           <NULL>                    NA    NA        NA       NA <int>
    #>  9 /tmp/RtmpuXyklO/file1f0c3…     4 stri… list(… <NA>           NA OPTIONAL        LIST           <LIST>                     1    NA        NA       NA <int>
    #> 10 /tmp/RtmpuXyklO/file1f0c3…     4 list  <NA>   <NA>           NA REPEATED        <NA>           <NULL>                     1    NA        NA       NA <int>
    #> 11 /tmp/RtmpuXyklO/file1f0c3…     4 elem… <NA>   BYTE…          NA OPTIONAL        UTF8           <STRING>                  NA    NA        NA       NA <int>
