...
```
    ...
    #>  1 /tmp/Rtmp7M8WRw/file1ef46…    NA sche… <NA>   <NA>           NA <NA>            <NA>           <NULL>                     4    NA        NA       NA <int>
    #>  2 /tmp/Rtmp7M8WRw/file1ef46…     1 id    integ… INT32          NA REQUIRED        INT_32         <INT(32, TRUE)>           NA    NA        NA       NA <int>
    #>  3 /tmp/Rtmp7M8WRw/file1ef46…     2 ints  list(… <NA>           NA OPTIONAL        LIST           <LIST>                     1    NA        NA       NA <int>
    #>  4 /tmp/Rtmp7M8WRw/file1ef46…     2 list  <NA>   <NA>           NA REPEATED        <NA>           <NULL>                     1    NA        NA       NA <int>
    #>  5 /tmp/Rtmp7M8WRw/file1ef46…     2 elem… <NA>   INT32          NA OPTIONAL        INT_32         <INT(32, TRUE)>           NA    NA        NA       NA <int>
    #>  6 /tmp/Rtmp7M8WRw/file1ef46…     3 doub… list(… <NA>           NA OPTIONAL        LIST           <LIST>                     1    NA        NA       NA <int>
    #>  7 /tmp/Rtmp7M8WRw/file1ef46…     3 list  <NA>   <NA>           NA REPEATED        <NA>           <NULL>                     1    NA        NA       NA <int>
    #>  8 /tmp/Rtmp7M8WRw/file1ef46…     3 elem… <NA>   DOUB…          NA OPTIONAL        <NA>           <NULL>                    NA    NA        NA       NA <int>
    #>  9 /tmp/Rtmp7M8WRw/file1ef46…     4 stri… list(… <NA>           NA OPTIONAL        LIST           <LIST>                     1    NA        NA       NA <int>
    #> 10 /tmp/Rtmp7M8WRw/file1ef46…     4 list  <NA>   <NA>           NA REPEATED        <NA>           <NULL>                     1    NA        NA       NA <int>
    #> 11 /tmp/Rtmp7M8WRw/file1ef46…     4 elem… <NA>   BYTE…          NA OPTIONAL        UTF8           <STRING>                  NA    NA        NA       NA <int>
